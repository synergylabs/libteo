#ifndef TEO_STORAGE_HPP
#define TEO_STORAGE_HPP
...
namespace teo
{
    ...
    private:
        ...
        static bool compare_owner_keys(const std::vector<std::string> &owners_val, const flatbuffers::Vector<flatbuffers::Offset<teo::DataStoreUpload::OwnerPubkey>> *owners_obj);
